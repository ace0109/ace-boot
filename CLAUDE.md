...
- ✅ 迭代开发完成后需要提交代码
- ⚠️ **注意**：AI讨论文档（AI_DISCUSSION.md）的更新不需要提交，只有迭代开发任务才需要提交
...
- **AI_DISCUSSION.md** - AI智能体讨论记录，包含重要的架构和工程决策
- **README.md** - 项目概述和快速参考

## AI讨论决策

项目采用多智能体协作模式，重要决策记录在 `AI_DISCUSSION.md` 中。当前已达成的共识：

1. **任务粒度**：复杂任务（如多模块改造）需要拆分为更小的子任务
2. **质量保障**：在开发前先配置自动化质量工具（JaCoCo、Checkstyle）
3. **覆盖率标准**：
   - 核心工具类：100% 覆盖率
   - 辅助工具类：90% 覆盖率
   - 配置类/常量类：不做强制要求
4. **文档状态**：架构文档需要标记实现状态（🔴未开始 🟡开发中 🟢已完成 ⏳计划中）
