...
**任务拆解：**
```
Task 4.1: 选型并接入社区成熟的字符串工具 (1h)
├── 验收标准：
│   ✅ 引入 commons-lang3 (StringUtils 等)
│   ✅ 提供统一工具入口或使用指南
│   ✅ 单元测试覆盖常见用法
└── 状态：已完成

Task 4.2: 选型并接入日期/时间工具 (1h)
├── 验收标准：
│   ✅ 使用 java.time + commons-lang3 DateUtils
│   ✅ 封装必要的格式化/解析适配
│   ✅ 单元测试覆盖
└── 状态：已完成

Task 4.3: JSON 工具选型 (1h)
├── 验收标准：
│   ✅ 直接使用 Jackson ObjectMapper
│   ✅ 提供最小封装（如 ObjectMapperHolder）
│   ✅ 单元测试覆盖泛型转换
└── 状态：已完成
```
